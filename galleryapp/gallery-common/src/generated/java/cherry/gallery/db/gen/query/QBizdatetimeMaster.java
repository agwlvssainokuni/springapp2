...
public class QBizdatetimeMaster extends com.querydsl.sql.RelationalPathBase<BBizdatetimeMaster> {
    ...
    public final DatePath<java.time.LocalDate> bizdate = createDate("bizdate", java.time.LocalDate.class);
    ...
    public final com.querydsl.sql.PrimaryKey<BBizdatetimeMaster> bizdatetimeMasterPkc = createPrimaryKey(id);
