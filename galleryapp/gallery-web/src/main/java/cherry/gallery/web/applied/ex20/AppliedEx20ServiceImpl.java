...
package cherry.gallery.web.applied.ex20;
...
import cherry.gallery.db.gen.query.QExTbl2;
...
public class AppliedEx20ServiceImpl implements AppliedEx20Service {
	...
	public AppliedEx20Form findById(long id) {
		QBean<AppliedEx20Form> qb = Projections.bean(AppliedEx20Form.class, et1.text10, et1.text100, et1.int64,
				et1.decimal1, et1.decimal3, et1.dt, et1.tm, et1.dtm, et1.lockVersion);
		QBean<AppliedEx20SubForm> qbSub = Projections.bean(AppliedEx20SubForm.class, et2.text10, et2.text100,
				et2.int64, et2.decimal1, et2.decimal3, et2.dt, et2.tm, et2.dtm, et2.lockVersion);
		AppliedEx20Form form = qf.from(et1).where(et1.id.eq(id)).select(qb).fetchOne();
