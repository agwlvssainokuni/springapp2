...
public interface CodeManager {
	 ...
	 */
	<T extends ICodeType<String>> boolean isValidValue(T codeEnum, String value);
	 ...
	 */
	<T extends ICodeType<String>> Map<String, String> getCodeMap(T codeEnum);
	 ...
	 * @return 区分値から表示名に対するマップ。
	 */
	<T extends ICodeType<String>> Map<String, String> getCodeMap(T codeEnum, boolean plainLabel);
