...
public interface NumberingManager {
	 ...
	 * @return 発行した番号 (文字列)。
	 */
	<T extends ICodeType<String>> String issueAsString(T numberEnum);
	 ...
	 */
	<T extends ICodeType<String>> String[] issueAsString(T numberEnum, int count);
	 ...
	 * @return 発行した番号 (整数値)。
	 */
	<T extends ICodeType<String>> long issueAsLong(T numberEnum);
	 ...
	 */
	<T extends ICodeType<String>> long[] issueAsLong(T numberEnum, int count);
