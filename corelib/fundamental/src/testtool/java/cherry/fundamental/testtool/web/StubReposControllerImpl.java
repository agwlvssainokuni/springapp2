...
import static cherry.elemental.util.ReflectionUtil.getMethodDescription;
...
import cherry.fundamental.testtool.stub.StubService;
...
public class StubReposControllerImpl implements StubReposController {
	...
	public void setJsonStubService(StubService jsonStubService) {
		this.jsonStubService = jsonStubService;
	}

	public void setYamlStubService(StubService yamlStubService) {
		this.yamlStubService = yamlStubService;
	}
