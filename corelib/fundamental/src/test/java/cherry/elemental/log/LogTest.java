...
import cherry.fundamental.log.trace.OnMemoryAppender;
...
public class LogTest {
	...
	public void debug() {
		...
		assertEquals("cherry.elemental.log.LogTest", e0.getLoggerName());
		...
		assertEquals("cherry.elemental.log.LogTest", e1.getLoggerName());
	...
	enum LogId implements ILogId {
		LOG101(cherry.elemental.log.Level.INFO), //
		LOG102(cherry.elemental.log.Level.WARN), //
		LOG103(cherry.elemental.log.Level.ERROR), //
		LOG201(cherry.elemental.log.Level.INFO), //
		LOG202(cherry.elemental.log.Level.WARN), //
		LOG203(cherry.elemental.log.Level.ERROR), //
		NOMSG(cherry.elemental.log.Level.INFO);

		private cherry.elemental.log.Level level;

		private LogId(cherry.elemental.log.Level level) {
			this.level = level;
		}
		...
		@Override
		public cherry.elemental.log.Level getLevel() {
			return level;
		}
	}
