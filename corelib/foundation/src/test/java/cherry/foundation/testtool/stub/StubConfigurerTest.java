...
public class StubConfigurerTest {
	...
	public void testConfigure1() throws IOException {
		...
		String json = "{\"cherry.foundation.testtool.ToolTester\":{\"toBeStubbed1(java.lang.Long,java.lang.Long)\":{\"data\":123}}}";
	...
	public void testConfigure1_withType() throws IOException {
		...
		String json = "{\"cherry.foundation.testtool.ToolTester\":{\"toBeStubbed1(java.lang.Long,java.lang.Long)\":{\"data\":123,\"type\":\"java.lang.Long\"}}}";
		Resource res = new ByteArrayResource(json.getBytes(StandardCharsets.UTF_8));
		configure(asList(res));
		assertEquals(1, repository.getStubbedMethod().size());
		assertEquals(method, repository.getStubbedMethod().get(0));
	...
	public void testConfigure1_withInvalidType() throws IOException {
		String json = "{\"cherry.foundation.testtool.ToolTester\":{\"toBeStubbed1(java.lang.Long,java.lang.Long)\":{\"data\":123,\"type\":\"INVALID_TYPE\"}}}";
		Resource res = new ByteArrayResource(json.getBytes(StandardCharsets.UTF_8));
		configure(asList(res));
	}
	...
	public void testConfigure2() throws IOException {
		...
		String json = "{\"cherry.foundation.testtool.ToolTester\":{\"toBeStubbed1(Long,Long)\":{\"data\":123}}}";
		Resource res = new ByteArrayResource(json.getBytes(StandardCharsets.UTF_8));
		configure(asList(res));
		assertEquals(1, repository.getStubbedMethod().size());
		assertEquals(method, repository.getStubbedMethod().get(0));
	...
	public void testConfigure3() throws IOException {
		...
		String json = "{\"cherry.foundation.testtool.ToolTester\":{\"toBeStubbed1\":{\"data\":\"123\"}}}";
		Resource res = new ByteArrayResource(json.getBytes(StandardCharsets.UTF_8));
		configure(asList(res));
	...
	public void testConfigure4() throws IOException {
		...
		String json = "{\"cherry.foundation.testtool.ToolTester\":{\"toBeStubbed2\":{\"data\":\"9999-12-31T23:59:59\"}}}";
		Resource res = new ByteArrayResource(json.getBytes(StandardCharsets.UTF_8));
		configure(asList(res));
		assertEquals(1, repository.getStubbedMethod().size());
		for (Method m : ToolTester.class.getDeclaredMethods()) {
	...
	public void testConfigure6() throws IOException {
		...
		String json = "{\"cherry.foundation.testtool.ToolTester\":{\"toBeStubbed1(Long,Long)\":[{\"data\":123},{\"data\":456},{\"data\":789}]}}";
		Resource res = new ByteArrayResource(json.getBytes(StandardCharsets.UTF_8));
		configure(asList(res));
		assertEquals(1, repository.getStubbedMethod().size());
		assertEquals(method, repository.getStubbedMethod().get(0));
